...
MODEL_PATH=/lustre/fsw/portfolios/coreai/users/erinh/llm-models/Qwen3-235B-A22B
...
exp_name="vllm-235B-fp8-${NNODES}nodes-pp${train_pp}-tp${train_tp}-ep${EP}-actor-length${actor_ppo_max_token_len}"
